...
class ExpenseController extends Controller
{
    ...
    {
        $expenses = \DB::select('SELECT * FROM heads WHERE h_type = ?', ['Expense']);
    ...
    {
        $types = \DB::select('SELECT tp_name FROM exptypes WHERE tp_type = ?', ['Expense']);
        return view('expenses.create', ['types'=>$types]);
    }
    ...
    public function edit($id)
    {
        ...
        $types = \DB::select('SELECT tp_name FROM exptypes WHERE tp_type = ?', ['Expense']);
        return view('expenses.edit',compact('expense','ex_ID'), ['types'=>$types]);
    }
