...
<head>
  ...
  <title>Inward Gate Pass <?php echo $details->gi_number; ?></title>
...
<body>
  ...
  <div style="float: right;margin-right: 80px;font-size: 16px;margin-top: 25px"><?php echo $details->gi_number; ?></div>
  </div>
  <br>
<header class="clearfix">
  <h3>Inward Gate pass</h3>
   <div style="font-size: 12px;"> <?php  $newDate = date("d-M-Y", strtotime($details->updated_at)); echo $newDate; ?> </div>
  <div style="font-size: 13px;"> <?php echo $details->gi_title; ?></div>
   <?php endforeach; ?>
</header>
<hr>
 ...
 <table style="padding-top: 40px">
               ...
               <?php foreach ($pass as $pass):?>
                <tr>
                  <td style="text-align: left"><?php echo $pass->gi_supplier; ?></td>
                  <td style="text-align: left"><?php echo $pass->gi_item; ?></td>
  ...
  <div style="position: fixed;bottom:65"> 
   ...
   <div id="notices" style="float: left">
        <div><u> <?php echo $details->gi_name; ?></u></div>
        <div>Prepared By</div>
      </div>       

      <div id="notices" style="float: left;margin-left: 225px">
        <div><u> <?php echo $details->gi_received_by; ?></u></div>
        <div>Received By</div>
      </div>
