...
<head>
  ...
  <title>Outward Gatepass <?php echo $details->go_number; ?></title>
...
<body>
  ...
  <div style="float: right;margin-right: 80px;font-size: 16px;margin-top: 25px"><?php echo $details->go_number; ?></div>
  </div>
  <br>
<header class="clearfix">
  <h3>OUTWARD GATEPASS</h3>
   <div style="font-size: 12px;">  <?php  $newDate = date("d-M-Y", strtotime($details->updated_at)); echo $newDate; ?> </div>
  <div style="font-size: 13px;"> <?php echo $details->go_title; ?></div>
  <div style="font-size: 12px;"><b> Customer: </b>  <?php echo $details->fr_name; ?></div>
   <?php endforeach; ?>
</header>
<hr>
 ...
 <table style="padding-top: 40px">
               ...
               <?php foreach ($pass as $pass):?>
                <tr>
                  <td style="text-align: left"><?php echo $pass->go_item; ?></td>
  ...
  <div style="position: fixed;bottom:65"> 
   ...
   <div id="notices" style="float: left">
        <div class="notice"><u> <?php echo $details->go_name; ?></u></div>
        <div>Prepared By</div>
      </div>       
