...
<head>
  ...
  <title>Purchase Requisition <?php echo $details->pr_number; ?></title>
...
<body>
  ...
  <div style="float: right;margin-right: 80px;font-size: 16px;margin-top: 25px"><?php echo $details->pr_number; ?></div>
  </div>
  <br>
<header class="clearfix">
  ...
  <div style="font-size: 13px;"> <?php echo $details->pr_title; ?></div>
   <?php endforeach; ?>
</header>
<hr>
 ...
 <table style="padding-top: 40px">
               ...
               <?php foreach ($pass as $pass):?>
                <tr>
                  <td style="text-align: left"><?php echo $pass->s_company; ?></td>
                  <td style="text-align: left"><?php echo $pass->pr_item; ?></td>
                  <td><?php echo $pass->pr_size; ?></td>
                  <td><?php echo $pass->pr_specs; ?></td>
                  <td><?php echo $pass->pr_description; ?></td>
                  <td><?php echo $pass->pr_quantity; ?></td>
                </tr>
                </tbody>
              <?php endforeach; ?>
    </table>
  ...
  <div style="position: fixed;bottom:65"> 
   ...
   <div id="notices" style="float: left">
        <div><u> <?php echo $details->pr_name; ?></u></div>
        <div>Prepared By</div>
      </div>       
