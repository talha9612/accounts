...
<!-- WORK AREA START -->
           <h3 align="center" class="text-primary">
            New Record <small class="text-muted">(Bank Payment)</small>
          </h3>
          <br>
          <form method="post" action="{{url('banktransactions')}}">
          <div id="fiscalyear">
                ...
                <!--  <div class="form-group">
                  ...
                  <div class="form-inline col-sm-12">
                    ...
                    <div class="form-group">
                          ...
                          <input class="form-control" type='number' data-type="cheque_number" id='cheque_number' name='cheque_number' required/>
                    </div>
...
<!--                         <tr>
                ...
                <br>
                <div align="center" >
               <a href="{{action('BanktransactionController@index')}}" class="btn btn-warning btn-raised">Cancel</a>
...
$(".addsr").on('click',function(){
  count=$('table tr').length;
      ...
      data+="<td><input class='form-control' type='text' id='srdebit_"+i+"' name='amnt[]' placeholder='Amount' required /></td>"
...
if(tot >  document.getElementById('openingbalance_1').value)
