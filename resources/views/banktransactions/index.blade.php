   ...
   <h3 align="center" class="text-primary">
    ...
    <div class="card">
        <div class="card-header card-header-rose card-header-icon bg-primary">
          ...
          <h4 class="card-title text-white">Bank Transactions</h4>
          <?php
          if(isset(Auth::user()->bpaymentsadd) && Auth::user()->bpaymentsadd == '1')
              { ?>
          <div align="right"><a href="{{action('BanktransactionController@create')}}" class="btn btn-success btn-raised" >+ Add New</a>
          </div>
           <?php } else {} ?>
        </div>
        <div class="card-body">
            ...
            <div class="row">
              ...
              <tbody>
                ...
                <tr role="row" class="odd">
                  ...
                  <td><?php echo $cashtransactions->acc_title; ?></td>
                  <td><?php $subtotal =  number_format($cashtransactions->bkvr_amount, 2, '.', ',');
                    echo $subtotal;?></td>
                  <td class="text-right" style="">
                        <a  href="{{action('BanktransactionController@show', $cashtransactions->bkvr_no)}}" class="btn btn-link btn-info btn-just-icon like" title="view">
