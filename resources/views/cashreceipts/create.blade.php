...
<!-- WORK AREA START -->
           <h3 align="center" class="text-primary">
            New Record <small class="text-muted">(Cash Receipt)</small>
          </h3>
          <br>
          <form method="post" action="{{url('cashreceipts')}}">
          <div id="fiscalyear">
         ...
         <!--                <tr>
                            ...
                            <td><input class="form-control" type='text'  id='balance' name='balance[]' required readonly /> </td>
                        </tr> -->
                        </table>
                    ...
                    <input class="form-control" type='number' id="vr_amount" name="vr_amount" required readonly /> 
                     <label for="r_balance" class="bmd-label-floating text-primary">New Balance</label>
                    <input class="form-control" type='number' id="r_balance" name="r_balance" required readonly /> 
                  </div>
                </div>
                <br>
                <div align="center" >
               <a href="{{action('CashreceiptController@index')}}" class="btn btn-warning btn-raised">Cancel</a>
...
$(".addfr").on('click',function(){
  count=$('table tr').length;
      ...
      data+="<td><input class='form-control farmer_txt' type='text'  data-type='frbalance' id='frbalance_"+i+"' name='frbalance[]' placeholder='Customer Balance' required/></td>";
