...
<!-- WORK AREA START -->
          ...
          <div class="col-md-4">Voucher#: <?php echo $details->vr_no; ?></div>
          <div class="col-md-4">CIH Title: <?php echo $details->cih_title; ?></div>
           <div class="col-md-4"> <?php  $newDate = date("d-M-Y", strtotime($details->created_at)); echo $newDate; ?> </div>
            <div class="col-md-4">Prepared By: <b><?php echo $details->ct_preparedby; ?></b></div>
           <?php endforeach; ?>
              ...
              <?php $total = 0; ?>
               <?php foreach ($voucher as $cashtransactions):?>
                <tr role="row" class="odd">
                  <td><?php echo $cashtransactions->ct_sno; ?></td>
                  ...
                  <td><?php $subtotal =  number_format($cashtransactions->ct_amount, 2, '.', ',');
                    echo $subtotal; $total += $cashtransactions->ct_amount; ?></td>
                </tr>
               <?php endforeach; ?>
                <tr>
                  <td></td>
       ...
       <!-- WORK AREA END -->  
      <script>
            printDivCSS = new String ('<head> <title> Star Automation </title><link href="{{asset("css/bootstrap-material-design.min")}}" rel="stylesheet" type="text/css"> </head> <div> <img src="{{asset("images/star.png")}}" width="20%" height="auto"></div> <h3 align="center"> CASH PAYMENT </h3> ')
