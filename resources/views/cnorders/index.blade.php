...
<?php
  if(isset(Auth::user()->cancelledordersview) && Auth::user()->cancelledordersview == '1')
      { ?>
    <!-- WORK AREA START -->
   <h3 align="center" style= "color: #3F729B">Cancelled Orders</h3>
    <div class="card">
        <div class="card-header card-header-rose card-header-icon "style="background-color: #3F729B">
          <div class="card-icon">
            <i class="material-icons">assignment</i>
          </div>
          <h4 class="card-title text-white" style="background-color: #3F729B">Cancelled Orders</h4>  
        </div>
            ...
            <div class="row">
              ...
              <thead style="background-color: #3F729B">
                <tr role="row">
                  ...
                  <th class="sorting text-white" tabindex="0" aria-controls="datatables" rowspan="1" colspan="1" style="width: 100px;" aria-label="Age: activate to sort column ascending">Total Price</th>
              <th class="disabled-sorting sorting text-white" tabindex="0" aria-controls="datatables" rowspan="1" colspan="1" style="width: 100px;" aria-label="Actions: activate to sort column ascending">Actions</th>
                </tr>
              </thead>
              ...
              <tbody>
                ...
                <td><?php $subtotal = number_format($record->Grand_total, 2, '.', ',');echo $subtotal;?></td>
                  <td style="text-align: center;">
                        ...
                        <button type="submit" class="btn btn-link btn-success btn-just-icon like" title="View Cancelled Order Details"> <i class="material-icons">visibility</i></button>
                        </form>     
                        </div>
                  </td>                                              
                </tr>
