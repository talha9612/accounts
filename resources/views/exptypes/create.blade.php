...
<!-- WORK AREA START -->
           <h3 align="center" class="text-primary">
            New Record <small class="text-muted">(Sub Types)</small>
          </h3>
          <br>
          <form method="post" action="{{url('exptypes')}}">
         {{csrf_field()}}
              ...
              <div class="card-header bg-primary" id="headingOne">
                <h5 class="mb-0">
                  <a class="btn btn-link text-white" data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                     <i class="material-icons text-warning">account_circle</i>Details
                  </a>
                </h5>
              </div>
                ...
                <div class="card-body bg-light">
                 <div class="container">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="name" required name="tp_name">
                        </div>
                        &nbsp &nbsp &nbsp &nbsp &nbsp
                    <div class="form-group">
                          <label for="stype" class="text-primary">Type</label>
                          <select class="form-control" type="select" id="stype" required name="tp_type">
                            <option value="Asset">Asset</option>
                            <option value="Liability">Liability</option>
                            <option value="Expense">Expense</option>
                            <option value="Current Asset">Income</option>
                          </select>
                        </div>
