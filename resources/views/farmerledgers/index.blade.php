...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#showWithDate1').on('click', function () {
            ...
            var request = $.get(base_url+'/StarAutomation/public/farmerledgers', data);
   ...
   <h3 align="center" class="text-primary">
     View Record <small class="text-muted">(Customers/Receivables Ledger)</small>
      </h3>
    <div class="card">
        <div class="card-header card-header-rose card-header-icon bg-primary">
          ...
          <h4 class="card-title text-white">Customers/Receivables Ledger</h4>
        </div>
        <div class="card-body">
            <div class="row">
          ...
          <div class="material-datatables">
            ...
            <div class="row">
              ...
              <thead class="bg-primary">
                <tr role="row">
                  <th class="sorting text-white" tabindex="0" aria-controls="datatables" rowspan="1" colspan="1" style="width: 50px;" aria-label="Account Number: activate to sort column ascending">Company Name</th>
                  ...
                  <th class="sorting text-white" tabindex="0" aria-controls="datatables" rowspan="1" colspan="1" style="width: 29px;" aria-label="Opening Balance: activate to sort column ascending">Closing Balance</th>
                   <th class="sorting text-white" tabindex="0" aria-controls="datatables" rowspan="1" colspan="1" style="width: 29px;" aria-label="Opening Balance: activate to sort column ascending">Due Date</th>
              ...
              <tbody>
                ...
                <tr role="row" class="odd">
                  <td tabindex="0" class="sorting_1"><?php echo $requisitions->fr_name; ?></td>
                  <td><?php $subtotal =  number_format($requisitions->fr_opbalance, 2, '.', ',');
                    echo $subtotal; ?>/-</td>
                    <td><?php $subtotal =  number_format($requisitions->fr_balance, 2, '.', ',');
                    echo $subtotal; ?>/-</td>
                  <td><?php echo $requisitions->fr_duedate; ?></td>
                  <td> <?php  $newDate = date("d-M-Y", strtotime($requisitions->updated_at)); echo $newDate; ?> </td>
                  <td class="text-right" style="">
                        <a  href="{{action('FarmerledgerController@show', $requisitions->fr_name)}}" class="btn btn-link btn-info btn-just-icon like" title="view">
                          <i class="material-icons">visibility</i>
                        </a>
                  </td>
                </tr>
                <?php $totalopening += $requisitions->fr_opbalance; ?>
                <?php $totalclosing += $requisitions->fr_balance; ?>
                <?php endforeach; ?>
                 <tr>
                  <td></td>
