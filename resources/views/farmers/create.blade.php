...
<!-- WORK AREA START -->
           <h3 align="center" class="text-primary">
            New Record <small class="text-muted">(Customers)</small>
          </h3>
          <br>
          <form method="post" action="{{url('farmers')}}">
         {{csrf_field()}}
                 ...
                 <div class="container">
                      ...
                      <div class="form-group">
                          ...
                          <!-- <input type="number" class="form-control" id="cnic" required name="fr_cnic"> -->
                           <input type="tel" id="fr_cnic" name="fr_cnic" pattern="[0-9]{13}" class="form-control" required>
                        </div>
                       <div class="form-group">
                  ...
                  <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordion">
                    <div class="card-body">
                       ...
                       <div class="form-group">
                          ...
                          <input type="text" class="form-control teacher_txt" data-type="tr_name" id="tr_name_1" required name="tr_name">
                        </div>
                         <div class="form-group">
                          <label for="amount" class="bmd-label-floating text-primary">CNIC Number</label>
                          <input type="number" class="form-control teacher_txt" data-type="tr_cnic" id="tr_cnic_1" required name="tr_cnic">
                        </div>
                         <div class="form-group">
                          <label for="amount" class="bmd-label-floating text-primary">Teacher ID</label>
                          <input type="number" class="form-control teacher_txt" data-type="tr_ID" id="tr_ID_1" required 
                          name="tr_ID">
                        </div>
                      </div>
                        <div class="form-group">
                          <label for="amount" class="bmd-label-floating text-primary">Amount</label>
                          <input type="number" class="form-control" id="amount" required name="fr_quota">
                    ...
                    <div class="card-body">
                       <div class="container">
                        <div class="form-inline bg-primary">
                         <div class="form-group">
                            ...
                            <input type="text" class="form-control guaranter_txt text-white" data-type="gr_name" id="gr_name_1" required name="gr_name_a">
                          </div>
                           <div class="form-group">
                            <label for="amount" class="bmd-label-floating text-white">CNIC</label>
                            <input type="number" class="form-control guaranter_txt text-white" data-type="gr_cnic" id="gr_cnic_1" required name="gr_cnic_a">
                          </div>
                           <div class="form-group">
                      ...
                      <div class="form-inline bg-dark">
                       <div class="form-group">
                          ...
                          <input type="text" class="form-control guaranter_txt text-white" data-type="gr_name" id="gr_name_2" required name="gr_name_b">
                        </div>
                         <div class="form-group">
                          <label for="amount" class="bmd-label-floating text-primary">CNIC</label>
                          <input type="number" class="form-control guaranter_txt text-white" data-type="gr_cnic" id="gr_cnic_2" required name="gr_cnic_b">
                        </div> 
                         <div class="form-group">
