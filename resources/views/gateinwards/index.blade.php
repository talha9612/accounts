...
<?php
  if(isset(Auth::user()->purchaseview) && Auth::user()->purchaseview == '1')
   ...
   <h3 align="center" class="text-primary">
     Posted <small class="text-muted">(Inward Gate Pass)</small>
      </h3>
    <div class="card">
        <div class="card-header card-header-rose card-header-icon bg-primary">
          ...
          <div align="right">
             <a href="{{action('GateinwardController@savedGp')}}" class="btn btn-success btn-raised" >Finalized Passes</a>
          </div>
        </div>
        <div class="card-body">
          <div class="toolbar">
            ...
            <div class="row">
              ...
              <tbody>
                ...
                <tr role="row" class="odd">
                  ...
                  <td><?php echo $orders->gi_number; ?></td>
                  <td><?php echo $orders->gi_title; ?></td>
                  <td><?php echo $orders->gi_name; ?></td>
                  <td><?php echo $orders->gi_received_by; ?></td>
                  <td class="text-right">
                        <a  href="{{action('GateinwardController@show', $orders->gi_number)}}" class="btn btn-link btn-info btn-just-icon like" title="view">
