...
<?php
  if(isset(Auth::user()->salesview) && Auth::user()->salesview == '1')
   ...
   <h3 align="center" class="text-primary">
     All <small class="text-muted">(Outward Gate Pass)</small>
      </h3>
    <div class="card">
        <div class="card-header card-header-rose card-header-icon bg-primary">
          ...
          <h4 class="card-title text-white">Outward Gate Pass</h4>
          <!-- <div align="right">
            ...
            <div class="row">
              ...
              <thead class="bg-primary">
                <tr role="row">
                  ...
                  <th class="sorting text-white" tabindex="0" aria-controls="datatables" rowspan="1" colspan="1" style="width: 83px;" aria-label="Office: activate to sort column ascending">Customer Name</th>
              ...
              <tbody>
                ...
                <tr role="row" class="odd">
                  ...
                  <td><?php echo $orders->go_number; ?></td>
                  <td><?php echo $orders->fr_name; ?></td>
                  <td><?php echo $orders->go_title; ?></td>
                  <td><?php echo $orders->go_name; ?></td>
                  <td class="text-right" style="">
                        <a  href="{{action('GateoutwardController@show', $orders->go_number)}}" class="btn btn-link btn-info btn-just-icon like" title="view">
