...
<!-- WORK AREA START -->
           <h3 align="center" class="text-primary">
            New Record <small class="text-muted">(Income)</small>
          </h3>
          <br>
          <form method="post" action="{{url('incomes')}}">
                 ...
                 <div class="container">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                          ...
                          <input type="text" class="form-control" id="type" required name="ex_type"  value="Income" readonly>
                        </div>
                         <div class="form-group">
