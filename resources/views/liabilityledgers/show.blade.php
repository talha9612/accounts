...
<?php
  if(isset(Auth::user()->liabilitiesledgersview) && Auth::user()->liabilitiesledgersview == '1')
      { ?>
<!-- WORK AREA START -->
<input type="hidden" name="counter" id="counter" value="Liabilities ledger">
           <?php foreach ($assetbalances as $assetorbalance):?>
           <h3 align="center" class="text-primary">
            Liabilities Ledger (<?php echo $assetorbalance->h_name; ?>)
          </h3>
          <br>
         ...
         <div id="div1">
           <table style="width: 100%;" id="myTable" border=".5px" class="table table-striped table-bordered table-hover dataTable dtr-inline">
            ...
            if($assetbalances ==null){
                 ...
                 $assetorbalance = new \stdClass();
                 $assetorbalance->h_name ='';
                 $assetorbalance->ob_amount = 0;
                 $assetorbalance->acc_balance=0;
                 $assetorbalance->h_balance=0;
            }else{
                $remaining = $assetorbalance->ob_amount + $remaining;
            }
            ?>
