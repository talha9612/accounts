...
<?php
  if(isset(Auth::user()->purchaseview) && Auth::user()->purchaseview == '1')
   ...
   <h3 align="center" class="text-primary">
     Posted <small class="text-muted">(Material Receiving Reports)</small>
      </h3>
    <div class="card">
        <div class="card-header card-header-rose card-header-icon bg-primary">
          ...
          <h4 class="card-title text-white">Material Receiving Reports</h4>
          <div align="right">
             <a href="{{action('MrreportController@finalRp')}}" class="btn btn-success btn-raised" >Finalized Reports</a>
          </div>
        </div>
        <div class="card-body">
          <div class="toolbar">
            ...
            <div class="row">
              ...
              <thead class="bg-primary">
                <tr role="row">
                  ...
                  <th class="sorting text-white" tabindex="0" aria-controls="datatables" rowspan="1" colspan="1" style="width: 83px;" aria-label="Office: activate to sort column ascending">Name</th>
                   ...
                   <th class="sorting text-white" tabindex="0" aria-controls="datatables" rowspan="1" colspan="1" style="width: 83px;" aria-label="Office: activate to sort column ascending">Lot Number</th>
              ...
              <tbody>
                ...
                <tr role="row" class="odd">
                  <td tabindex="0" class="sorting_1"> <?php  $newDate = date("d-M-Y", strtotime($reports->updated_at)); echo $newDate; ?> </td>
                  <td><?php echo $reports->mr_number; ?></td>
                  <td><?php echo $reports->mr_title; ?></td>
                  <td><?php echo $reports->mr_name; ?></td>
                  <td><?php echo $reports->mr_received_by; ?></td>
                   <td><?php echo $reports->lot_number; ?></td>
                  <td class="text-right">
                        <a  href="{{action('MrreportController@show', $reports->mr_number)}}" class="btn btn-link btn-info btn-just-icon like" title="view">
