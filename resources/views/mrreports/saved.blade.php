...
<?php
  if(isset(Auth::user()->purchaseview) && Auth::user()->purchaseview == '1')
   ...
   <h3 align="center" class="text-primary">
     Finalized <small class="text-muted">(Material Receiving Reports)</small>
      </h3>
    <div class="card">
            ...
            <div class="row">
              ...
              <tbody>
                ...
                <tr role="row" class="odd">
                  ...
                  <td><?php echo $requisition->mr_number; ?></td>
                  <td><?php echo $requisition->mr_title; ?></td>
                  <td><?php echo $requisition->mr_name; ?></td>
                  <td><?php echo $requisition->lot_number; ?></td>
                   <td class="text-right" style="">
                        <a  href="{{action('MrreportController@show', $requisition->mr_number)}}" class="btn btn-link btn-info btn-just-icon like" title="view">
