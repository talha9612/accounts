...
@section('content')
    ...
    <div class="card">
        <div class="card-header bg-primary">
          <h1 align="center" class="card-title text-white" <string>CLOSING Obalance</string> </h1>
        </div>
        <div class="card-body">
                ...
                <div class="card-body">
                  ...
                  <div class="material-datatables">
                   <div id="datatables_wrapper" class="dataTables_wrapper dt-bootstrap4">
                    ...
                    <div class="card-body">
                        <h3 align="center" class="text-primary">
                        Asset & Liability Ledger<small class="text-muted"></small>
                              </h3>
                      <div class="material-datatables">
                       <div id="datatables_wrapper" class="dataTables_wrapper dt-bootstrap4">
                        <div class="row">
                          ...
                          <tbody>
                             @foreach($closing_record_heads as $closing_record_head)
                            <tr>
