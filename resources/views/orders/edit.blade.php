...
<!-- WORK AREA START -->
          ...
          <?php foreach ($records as $details):?>
             <form method="post" action="{{action('QuotationController@update', $details->QuotationNumber)}}">
         {{csrf_field()}}
        <input name="_method" type="hidden" value="PATCH">
          ...
          <div class="form-inline">
            ...
            <div class="form-group">
                ...
                <input class="form-control" type='text' name='cname' value="<?php echo $details->CustomerName; ?>"/>
            </div>
            <div class="form-group">
                <label class="bmd-label-floating"style= "color: #3F729B">Customer RFQ</label>
                <input class="form-control" type='text' name='crfq' value="<?php echo $details->CustomerRFQ; ?>"/>
            </div>
              <div class="form-group">
                <label class="bmd-label-floating"style= "color: #3F729B">Attn</label>
                <input class="form-control" type='text' name='cattn' value="<?php echo $details->Attn; ?>"/>
            </div>          
            <div class="form-group">
                <label class="bmd-label-floating"style= "color: #3F729B">Designation</label>
                <input class="form-control" type='text' name='cdesignation' value="<?php echo $details->Designation; ?>"/>
            </div>
            <div class="form-group">
                <label class="bmd-label-floating"style= "color: #3F729B">Location</label>
                <input class="form-control" type='text' name='carea' value="<?php echo $details->Location; ?>"/>
            </div>
            <div class="form-group">
                <label class="bmd-label-floating"style= "color: #3F729B">Contact Number</label>
                <input class="form-control" type='text' name='cnum' value="<?php echo $details->ContactNum; ?>"/>
            </div>
            <div class="form-group">
                <label class="bmd-label-floating"style= "color: #3F729B">Email Adress</label>
                <input class="form-control" type='text' name='cemail' value="<?php echo $details->Email; ?>"/>
            </div>                     
            </div>
