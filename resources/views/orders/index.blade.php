   ...
   <h3 align="center" style= "color: #3F729B">
    ...
    <div class="card">
        <div class="card-header card-header-rose card-header-icon "style="background-color: #3F729B">
          ...
          <h4 class="card-title text-white" style="background-color: #3F729B" >Orders Received</h4>  
        </div>
              ...
              <tbody>
                ...
                <td><?php $subtotal = number_format($record->Grand_total, 2, '.', ',');echo $subtotal;?></td>
                  <td style="text-align: center;">
                        ...
                        <button type="submit" class="btn btn-link btn-success btn-just-icon like" title="View Order Details"> <i class="material-icons">visibility</i></button>
                        </form>     
                        </div>
                  </td>                                              
                </tr>
