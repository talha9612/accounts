...
<?php
  if(isset(Auth::user()->purchaseview) && Auth::user()->purchaseview == '1')
   ...
   <h3 align="center" class="text-primary">
     Import <small class="text-muted">(Purchase Orders)</small>
      </h3>
    <div class="card">
        <div class="card-header card-header-rose card-header-icon bg-primary">
          ...
          <h4 class="card-title text-white">Purchase Orders (Import)</h4>
           <div align="right">
            <!--  <a href="{{action('PrequisitionController@index')}}" class="btn btn-success btn-raised" >Posted PR's</a>
               <a href="{{action('PrequisitionController@create')}}" class="btn btn-success btn-raised" >+ Add New</a> -->
                <a href="{{action('PorderController@importFinal')}}" class="btn btn-success btn-raised" >Finalized Po's</a>
          </div>
            ...
            <div class="row">
              ...
              <thead class="bg-primary">
                <tr role="row">
                  ...
                  <th class="sorting text-white" tabindex="0" aria-controls="datatables" rowspan="1" colspan="1" style="width: 83px;" aria-label="Office: activate to sort column ascending">Name</th>
                   <th class="sorting text-white" tabindex="0" aria-controls="datatables" rowspan="1" colspan="1" style="width: 83px;" aria-label="Office: activate to sort column ascending">Total Price</th>
              ...
              <tbody>
                ...
                <tr role="row" class="odd">
                  ...
                  <td><?php echo $requisition->po_number; ?></td>
                  <td><?php echo $requisition->po_title; ?></td>
                  <td><?php echo $requisition->po_name; ?></td>
                  <td><?php $subtotal =  number_format($requisition->po_grandtotal, 2, '.', ',');
                    echo $subtotal; ?></td>
                   <td class="text-right" style="">
                        <a  href="{{action('PorderController@showImport' , $requisition->po_number)}}" class="btn btn-link btn-info btn-just-icon like" title="view">
