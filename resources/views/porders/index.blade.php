...
<?php
  if(isset(Auth::user()->purchaseview) && Auth::user()->purchaseview == '1')
   ...
   <h3 align="center" class="text-primary">
     Posted <small class="text-muted">(Purchase Orders)</small>
      </h3>
    <div class="card">
        <div class="card-header card-header-rose card-header-icon bg-primary">
          ...
          <h4 class="card-title text-white">Purchase Orders</h4>
          <div align="right">
             <a href="{{action('PorderController@savedPo')}}" class="btn btn-success btn-raised" >Finalized Po's</a>
             <!--  <a href="{{action('PorderController@importPo')}}" class="btn btn-success btn-raised" >Import Po's</a> -->
          </div>
        </div>
        <div class="card-body">
          <div class="toolbar">
              ...
              <tbody>
                ...
                <tr role="row" class="odd">
                  ...
                  <td class="text-right" style="">
                        <a  href="{{action('PorderController@show', $orders->po_number)}}" class="btn btn-link btn-info btn-just-icon like" title="view">
