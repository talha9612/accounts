...
<?php
  if(isset(Auth::user()->purchaseview) && Auth::user()->purchaseview == '1')
   ...
   <h3 align="center" class="text-primary">
     Finalized <small class="text-muted">(Purchase Orders)</small>
      </h3>
    <div class="card">
                ...
                <tr role="row" class="odd">
                  ...
                  <td><?php $subtotal =  number_format($requisition->po_grandtotal, 2, '.', ',');
                   ...
                   <td class="text-right" style="">
                        <a  href="{{action('PorderController@show', $requisition->po_number)}}" class="btn btn-link btn-info btn-just-icon like" title="view">
