...
<?php
  if(isset(Auth::user()->purchaseview) && Auth::user()->purchaseview == '1')
   ...
   <h3 align="center" class="text-primary">
     Posted <small class="text-muted">(Purchase Requisitions)</small>
      </h3>
    <div class="card">
        <div class="card-header card-header-rose card-header-icon bg-primary">
          ...
          <div align="right">
            <a href="{{action('PrequisitionController@savedPr')}}" class="btn btn-success btn-raised" >Saved PR's</a>
            <a href="{{action('PrequisitionController@finalPr')}}" class="btn btn-success btn-raised" >Finalized PR's</a>
              ...
              <tbody>
                ...
                <tr role="row" class="odd">
                  ...
                  <td class="text-right" style="">
                        <a  href="{{action('PrequisitionController@show', $requisition->pr_number)}}" class="btn btn-link btn-info btn-just-icon like" title="view">
                          <i class="material-icons">visibility</i>
                        </a>   
                    <form action="{{action('PrequisitionController@unpostPr', $requisition->pr_number)}}" method="get" style="display: inline;">
