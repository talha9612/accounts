...
<!-- WORK AREA START -->
        ...
        <form method="post" action="{{url('quotes')}}">
                ...
                <div class="form-group" style="width: 33.33%">
                <label style= "color: #3F729B">Issue Date</label>
                <input type="date" style="width: 100%" name="idate" class="form-control">
                </div>
                <div class="form-group" style="width: 33.33%">
                <label style= "color: #3F729B">Valid Till</label>
                <input type="date" style="width: 100%;background-color: pink" class="form-control" required name="validtill">
                </div>
                </div>
                ...
                <textarea name="notes" class="form-control" id="exampleFormControlTextarea3" rows="3" style="width: 100%"><?php foreach ($records as $details):?><?php echo $details->AdditionalComments; ?><?php endforeach; ?></textarea>
                </textarea>
                </div>
                <br>
                ...
                <tr>
                    <th><input class='check_all' type='checkbox' style ='width: 10%'onclick="select_all()"/></th>
                ...
                <input class="form-control"style="width: 100%" type='number' id="gstp" name="gstp" required value="18" />
                </div>
                <div class="form-group" style="width: 50%">
