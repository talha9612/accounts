...
<?php
  if(isset(Auth::user()->purchaseview) && Auth::user()->purchaseview == '1')
   ...
   <h3 align="center" class="text-primary">
     Posted <small class="text-muted">(Stock Cost Valuations)</small>
      </h3>
    <div class="card">
        <div class="card-header card-header-rose card-header-icon bg-primary">
          ...
          <h4 class="card-title text-white">Stock Cost Valuations</h4>
          <!-- <div align="right">
             <a href="{{action('PorderController@savedPo')}}" class="btn btn-success btn-raised" >Finalized Po's</a>
          </div> -->
        </div>
        <div class="card-body">
          <div class="toolbar">
            ...
            <div class="row">
              ...
              <tbody>
                ...
                <tr role="row" class="odd">
                  ...
                  <td><?php echo $orders->sc_number; ?></td>
                  <td><?php echo $orders->sc_title; ?></td>
                  <td><?php echo $orders->sc_name; ?></td>
                  <td><?php echo $orders->lot_number; ?></td>
                  <td class="text-right" style="">
                        <a  href="{{action('ScvaluationController@show', $orders->sc_number)}}" class="btn btn-link btn-info btn-just-icon like" title="view">
