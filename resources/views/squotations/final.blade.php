   ...
   <h3 align="center" class="text-primary">
    ...
    <div class="card">
        <div class="card-header card-header-rose card-header-icon bg-primary">
          ...
          <h4 class="card-title text-white">Sale Invoices</h4>
           <div align="right">
             <a href="{{action('SquotationController@index')}}" class="btn btn-success btn-raised" >Posted SQ's</a>
          </div>
        </div>
        <div class="card-body">
          <div class="toolbar">
            ...
            <div class="row">
              ...
              <tbody>
                ...
                <tr role="row" class="odd">
                  <td><?php echo $requisition->sq_number; ?></td>
                  <td tabindex="0" class="sorting_1"><?php  $newDate = date("d-M-Y", strtotime($requisition->updated_at)); echo $newDate; ?></td> 
                  <td><?php echo $requisition->sq_title; ?></td>
                  <td><?php echo $requisition->sq_name; ?></td>
                  <td class="text-right">
                    <a  href="{{action('SquotationController@show', $requisition->sq_number)}}" class="btn btn-link btn-info btn-just-icon like" title="view">
