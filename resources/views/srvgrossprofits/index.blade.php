...
<?php
  if(isset(Auth::user()->serviceview) && Auth::user()->serviceview == '1')
   ...
   <h3 align="center" class="text-primary">
     All <small class="text-muted">(Service Gross Profits)</small>
      </h3>
    <div class="card">
        <div class="card-header card-header-rose card-header-icon bg-primary">
          ...
          <h4 class="card-title text-white">Service Gross Profit</h4>
        </div>
        <div class="card-body">
          <div class="toolbar">
              ...
              <tbody>
                ...
                <tr>
                  ...
                  <td class="text-right" style="">
                        <a  href="{{action('SrvgrossprofitController@show', $requisition->svi_number)}}" class="btn btn-link btn-info btn-just-icon like" title="view">
